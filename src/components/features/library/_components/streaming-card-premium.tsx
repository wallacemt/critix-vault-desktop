            ...
            <div className="flex-1 flex flex-col justify-between min-w-0">
              <div>
                <div className="flex items-start gap-2 mb-2">
                  <h3 className="font-bold text-[var(--text-primary)] text-lg line-clamp-1 font-display flex-1">
                    {media.title}
                  </h3>
                  <Badge
                    variant="secondary"
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Info Section */}
        <div className="p-4">
          <h3 className="font-bold text-[var(--text-primary)] text-sm line-clamp-2 mb-2 font-display leading-tight">
            {media.title}
          </h3>
