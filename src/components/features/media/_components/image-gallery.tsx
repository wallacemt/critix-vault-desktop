    ...
    <>
      ...
      <Dialog open={fullscreenOpen} onOpenChange={setFullscreenOpen}>
        <DialogContent
          ...
          className=" bg-black border-0 inset-0 w-full h-full max-w-none translate-x-0 translate-y-0 rounded-none lg:top-[50%] lg:left-[50%] lg:max-w-6xl lg:translate-x-[-50%] lg:translate-y-[-50%] lg:max-h-[90vh] lg:rounded-lg p-0 overflow-hidden flex flex-col overflow-y-auto"
        >
